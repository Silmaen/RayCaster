...
if (CMAKE_SYSTEM_NAME MATCHES "Windows")
    ...
    if (MINGW)
        message(STATUS "Detected Operating System MinGW on '${CMAKE_SYSTEM_NAME}'")
    else ()
        message(ERROR "Unsupported environment, only mingw is allowed on windows")
    endif ()
...
if (CMAKE_BUILD_TYPE MATCHES "Debug")
    add_compile_definitions(RAY_DEBUG)
endif ()
