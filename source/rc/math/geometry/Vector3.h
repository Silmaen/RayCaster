...
public:
    ...
    Vector3(const Vector3<DatatypeOther>& other):X{static_cast<DataType>(other[0])},Y{static_cast<DataType>(other[1])},Z{static_cast<DataType>(other[2])}{}
    /**
     * @brief Copy constructor with type change
     * @tparam DatatypeOther The other's type
     * @param other The vector to copy
     */
    template<class DatatypeOther>
    Vector3(const Vector2<DatatypeOther>& other):X{static_cast<DataType>(other[0])},Y{static_cast<DataType>(other[1])},Z{0}{}
    /**
